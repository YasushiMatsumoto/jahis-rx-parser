...
- `201` の一般名関連項目は保持済みだが、コード体系の validate は未整理。
...
| `201`      | 薬品レコード                           | Partially Supported | Yes     | Yes       | Partial  | Yes      | 一般名3項目まで保持。一般名コード体系の validate は未整備。           |
...
- `201` の一般名コード体系をコード表ノートと validate に反映。
